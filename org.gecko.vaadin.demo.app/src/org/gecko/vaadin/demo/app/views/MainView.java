 ...
 */
@PWA(name = "DIM App", shortName = "DIM App", enableInstallPrompt = false)
@JsModule("/resources/frontend/styles/shared-styles.js")
@CssImport("/resources/frontend/views/main/main-view.css")
...
public class MainView extends AppLayout {
    ...
    private com.vaadin.flow.component.Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "DIM App logo"));
        logoLayout.add(new H1("DIM App"));
    ...
    private com.vaadin.flow.component.Component[] createMenuItems() {
        return new Tab[]{createTab("Hello World", HelloWorldView.class), createTab("Person Form", PersonFormView.class),
              createTab("Map", MapView.class), createTab("About", AboutView.class)};
    }
//    private Component[] createMenuItems() {
//    	return new Tab[]{createTab("Hello World", HelloWorldView.class), createTab("Person Form", PersonFormView.class),
//    			createTab("Master-Detail", MasterDetailView.class), createTab("Map", MapView.class),
