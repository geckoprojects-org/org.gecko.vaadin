...
/**
 * The link to the java script classes from the flow-client JAR. This content is repackaged into this bundle.
 ...
 */
@Capability(namespace = Constants.VAADIN_CAPABILITY_NAMESPACE, name = Constants.VAADIN_CAPABILITY_CLIENT)
@Component(service = VAADINResourceProvider.class, immediate = true, configurationPolicy = ConfigurationPolicy.REQUIRE, name = Constants.CM_CLIENT)
